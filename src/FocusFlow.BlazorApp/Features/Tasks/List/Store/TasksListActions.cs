...
/// </summary>
public static class TasksListActions
{
	// ============================================================================
	...
	/// </summary>
	public record LoadTasksSuccessAction(List<TaskResponse> Tasks);
	...
	/// </summary>
	public record UpdateTaskSuccessAction(TaskResponse Task);
	...
	/// </summary>
	public record UpdateTaskStatusSuccessAction(TaskResponse Task);
